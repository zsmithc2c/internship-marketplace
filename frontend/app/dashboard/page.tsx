  ...
  return (
    <main className="pt-14">
      ...
      <section className="relative isolate overflow-hidden bg-gradient-to-br from-indigo-500 via-violet-600 to-fuchsia-600">
        <div className="absolute inset-0 opacity-30 mix-blend-soft-light [mask-image:radial-gradient(transparent_40%,black)]" />
        <div className="mx-auto flex max-w-5xl flex-col items-center gap-4 px-6 py-20 text-center">
          ...
          <button
            ...
            className="group mt-4 inline-flex items-center gap-1 rounded-md bg-white/10 px-4 py-2 text-sm font-medium text-white ring-1 ring-inset ring-white/20 backdrop-blur-lg transition hover:bg-white/20"
          >
